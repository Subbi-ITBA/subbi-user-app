...
class EmailSignInBox extends StatefulWidget {
  ...
  const EmailSignInBox({Key key, this.parentCallback})
      : super(
          key: key,
        );
...
class _EmailSignInBoxState extends State<EmailSignInBox> {
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                validator: (String email) {
                  if (email == null || email == "") return 'Campo requerido';
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                validator: (String pass) {
                  if (pass == null || pass == '') return 'Campo requerido';
                  if (pass.length < 8) return 'Debe tener más de 8 caracteres';
              ...
              child: Row(
                  ...
                  children: [
                    OutlineButton(
                        ...
                        onPressed: () => signIn()),
                    OutlineButton(
                        child: Text('Crear cuenta'), onPressed: () => signUp())
                  ]),
            ),
            Padding(
                padding: const EdgeInsets.all(8.0),
  ...
  builAuthStateIndicator(String authState) {
    if (authState == null || authState == '') return Container();

    if (authState == 'loading') return CircularProgressIndicator();
