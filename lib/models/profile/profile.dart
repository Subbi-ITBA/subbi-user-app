...
class Profile {
  ...
  Profile({
    @required this.user, @required this.uid,
    @required this.name, @required this.profilePicURL,
    @required this.location, @required this.chat,
  ...
  static Future<Profile> getProfile({@required String ofUid}) async => 
    Profile(
      name: "Carlos Gardel",
      profilePicURL: "https://cdn3.iconfinder.com/data/icons/avatars-round-flat/33/avat-01-512.png",
      location: null,
      uid: null,
      user: null,
      chat: null,
  ...
  static Profile _fromJson(Map<String, dynamic> json) => throw UnimplementedError();
